...
public class CarsClientAdapter extends ArrayAdapter<Car> {


    public CarsClientAdapter(Context ct, ArrayList<Car> carArrayList){
        super(ct, R.layout.client_car_row, carArrayList);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.client_car_row, parent,false);
        }
